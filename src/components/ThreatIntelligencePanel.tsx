...
import { AlertTriangle, ExternalLink, ShieldAlert, RefreshCw } from 'lucide-react';
  ...
  return (
    <div className="bg-white border border-zinc-200 rounded-lg p-5 mb-6 shadow-xs">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center space-x-2">
          ...
          <h2 className="text-sm font-semibold text-zinc-900 tracking-tight">
            Live CISA Sector Threat Intelligence (KEV Feed)
          </h2>
          <span className="bg-rose-100 text-rose-800 text-[10px] font-mono px-2 py-0.5 rounded font-medium">
            Active Exploits
          </span>
        </div>
        <button
      ...
      <p className="text-xs text-zinc-500 mb-4">
        Correlated live CISA Known Exploited Vulnerabilities impacting enterprise security controls.
      </p>
          ...
          >
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <span className="font-mono text-xs font-semibold text-rose-700 bg-rose-50 px-1.5 py-0.5 rounded border border-rose-200/60">
                  {entry.cveID}
                </span>
