...
export const NIST_CSF_OUTCOMES: NistOutcome[] = [
  ...
  },
  {
    ...
    description: 'Risk management objectives, risk appetite, and risk tolerances are established, communicated, and updated.',
    sp80053Controls: [
      { code: 'PM-28', title: 'Risk Frame', family: 'Program Management' },
      { code: 'RA-2', title: 'Security Categorization', family: 'Risk Assessment' }
    ],
    iso27001Controls: [{ code: 'A.5.2', title: 'Information security roles and responsibilities' }],
  ...
  },
  {
    ...
    description: 'Cybersecurity supply chain risk management processes are established, managed, and monitored for third-party providers.',
    sp80053Controls: [
      { code: 'SR-3', title: 'Supply Chain Controls and Processes', family: 'Supply Chain Risk' },
      { code: 'SR-5', title: 'Acquisition Strategies, Tools, and Methods', family: 'Supply Chain Risk' }
    ],
    iso27001Controls: [{ code: 'A.5.19', title: 'Information security in supplier relationships' }],
    doraMapping: { article: 'Art. 28', title: 'Managing ICT Third-Party Risk' },
    nis2Mapping: { article: 'Art. 21.2d', title: 'Supply Chain Security & Supplier Relationships' }
  },
  ...
  },
  {
    ...
    description: 'Asset vulnerabilities are identified, validated, and documented in vulnerability registers.',
    sp80053Controls: [
      { code: 'RA-5', title: 'Vulnerability Monitoring and Scanning', family: 'Risk Assessment' },
      { code: 'SI-2', title: 'Flaw Remediation', family: 'System Integrity' }
    ],
    iso27001Controls: [{ code: 'A.8.8', title: 'Management of technical vulnerabilities' }],
  ...
  // --- PROTECT ---
  {
    ...
    sp80053Controls: [
      ...
      { code: 'IA-2', title: 'Identification and Authentication', family: 'Identification & Auth' }
    ],
    iso27001Controls: [
  ...
  },
  {
    ...
    sp80053Controls: [
      { code: 'SC-8', title: 'Transmission Confidentiality and Integrity', family: 'System Comms' },
      { code: 'SC-28', title: 'Protection of Information at Rest', family: 'System Comms' }
    ],
    iso27001Controls: [
  ...
  },
  {
    ...
    description: 'Configuration baselines are established and maintained for all operational platforms, operating systems, and network hardware.',
    sp80053Controls: [
      { code: 'CM-2', title: 'Baseline Configuration', family: 'Configuration Management' },
      { code: 'CM-6', title: 'Configuration Settings', family: 'Configuration Management' }
    ],
    iso27001Controls: [{ code: 'A.8.9', title: 'Configuration management' }],
    doraMapping: { article: 'Art. 9.4', title: 'System Architecture & Baseline Hardening' },
    nis2Mapping: { article: 'Art. 21.2e', title: 'Security in Network System Acquisition' }
  },
  ...
  // --- DETECT ---
  {
    ...
    sp80053Controls: [
      ...
      { code: 'AU-6', title: 'Audit Record Review and Analysis', family: 'Audit & Accountability' },
  ...
  },
  {
    ...
    description: 'Anomalous events are analyzed to understand attack vectors, impact, and correlation with threat intelligence indicators (CTI).',
    sp80053Controls: [
      { code: 'SI-5', title: 'Security Alerts and Advisories', family: 'System Integrity' },
      { code: 'AU-12', title: 'Audit Record Generation', family: 'Audit & Accountability' }
    ],
    iso27001Controls: [{ code: 'A.8.15', title: 'Logging' }],
    doraMapping: { article: 'Art. 10.2', title: 'Threat Intelligence & Alert Correlation' },
    nis2Mapping: { article: 'Art. 21.2c', title: 'Security Incident Detection & Analysis' }
  },
  ...
  },
  {
    ...
    description: 'Personnel, executive management, legal teams, and external regulatory authorities are notified according to regulatory timelines.',
    sp80053Controls: [{ code: 'IR-7', title: 'Incident Response Assistance', family: 'Incident Response' }],
  ...
  // --- RECOVER ---
  {
    ...
    sp80053Controls: [
      ...
      { code: 'CP-10', title: 'Information System Recovery', family: 'Contingency Planning' }
    ],
    iso27001Controls: [
